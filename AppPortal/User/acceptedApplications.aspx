<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="acceptedApplications.aspx.cs" Inherits="AppPortal.User.acceptedApplications1" %>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Here is the list of your accepted applications.</p>
                </div>
                <div class="card-body">
                <div class="table-responsive">
               
                    <asp:GridView ID="Accp_app" DataKeyNames="AppId" AutoGenerateColumns="false" CellPadding="0" HeaderStyle-CssClass="text-primary" CellSpacing="0" GridLines="None" BorderStyle="None" CssClass="table" runat="server">
