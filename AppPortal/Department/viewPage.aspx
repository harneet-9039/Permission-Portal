<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Accepted.aspx.cs" Inherits="AppPortal.Department.Accepted" %>
...
<head runat="server">
  ...
  <link rel="icon" type="image/png" href="../Department/assets/img/favicon.png">
...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="white" data-image="../Department/assets/img/sidebar-1.jpg">
      <!--
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright float-right">
            ...
            <a href="https://www.creative-tim.com" target="_blank">Team</a> for a better web.
          </div>
        </div>
      </footer>
    </div>
