...
.modal{
    display:none;position:absolute;z-index:1;padding-top:100px;left:0;top:0;width:100%;height:100%;overflow:auto;background-color:#000;background-color:rgba(0,0,0,.4)}
.modal-content{
    background-color:#fefefe;margin:auto;padding:20px;border:1px solid #888;width:80%}                                                                                                                   
 .close{
     color:#aaa;float:right;font-size:28px;font-weight:700}
                                                                                                                                                                                                                                                                        .close:focus,
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Applied Applications </h4>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <button type="submit" class="btn btn-primary myBtn" data-modal="myModalA" style="height:30px;padding-top:8px;">View</button>
                              <div id="myModalA" class="modal"><div class="modal-content">
                                  <span class="close">&times;</span>
                                  <p><embed src="SwastikaRai_2017CA47_MNNIT_Allahabad.pdf" width="800px" height="2100px" /></p>
                               </div></div>
                          </td>
