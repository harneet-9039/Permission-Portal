            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Applications Accepted</h4>
                  <p class="card-category"> Here is the list of applications accepted by you.(* Please disable any download manager for better experience.)</p>
                </div>
                <div class="card-body">
